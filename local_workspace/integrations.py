...
CATALOG = (
    ...
    {"id": "gmail", "name": "Gmail Reply Drafts", "decision": "ready_when_configured", "access": "read and create drafts; no send tool", "cost": "free quota", "description": "Imports new Gmail, prepares replies with local Ollama, requests approval, and saves approved replies to Gmail Drafts.", "available": lambda: Path(os.environ.get("DAKSH_GOOGLE_TOKEN_FILE", Path(__file__).resolve().parent / "data" / "connectors" / "google_token.json")).is_file()},
