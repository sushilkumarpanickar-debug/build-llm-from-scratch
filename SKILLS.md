...
| Communications bridge | Review Telegram/WhatsApp instructions, Gmail replies, approvals, and Google Calendar in DAKSH | Approved by the user's 14 September 2026 request. Telegram and WhatsApp require sender allowlists; Calendar is read-only; Gmail may read and create approved drafts but has no send operation; approved instructions stage local missions. |
